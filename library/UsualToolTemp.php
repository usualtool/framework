...
class UTTemp{
    ...
    function TempReplace($content){
		...
		'/<\{\s*datatree\s*=>\s*([0-9]*),\$([a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*),(.+?)\s*\}>/is',
        '/<\{\s*lang\s*=>\s*set->(.+?),(.+?)\s*\}>/is',
        '/<\{\s*lang\s*=>\s*(.+?)\s*\}>/i',
